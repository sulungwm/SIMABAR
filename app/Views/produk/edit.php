                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="/produk/update/<?= $produk['id_produk']; ?>" method="post">
                            <div class="form-group">
                                ...
                                <select class="form-control js-example-basic-single w-100" name="id_kategori" required>
                                    ...
                                    <?php foreach ($kategori as $key) : ?>
                                        <option value="<?= $key['id_kategori']; ?>" <?php if ($key['id_kategori'] == $produk['id_kategori']) echo 'selected="selected"'; ?>><?= $key['nama_kategori']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control js-example-basic-single w-100" name="id_jenis" required>
                                    ...
                                    <?php foreach ($jenis as $key) : ?>
                                        <option value="<?= $key['id_jenis']; ?>" <?php if ($key['id_jenis'] == $produk['id_jenis']) echo 'selected="selected"'; ?>><?= $key['nama_jenis']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="stock" value="<?= $produk['stock']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Harga</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" required class="form-control" style="min-height:100px"><?= $produk['deskripsi']; ?></textarea>
                            </div>
